...
* **Faction zone** is the social control layer (who sets norms, who enforces behavior, and whose trust or suspicion matters most)
* **Location** is a concrete place inside that faction zone where specific loops happen

This means a faction zone can contain multiple locations. Faction zones identify social ownership and pressure context.

## Matrix

| Location | Faction zone | Baseline type | Primary role | Risk profile | Keep decision | Readiness | Required rework summary | Profile |
|---|---|---|---|---|---|---|---|---|
...
| Church | Church zone | Existing | Safe recovery | Low | Keep | Review complete | Keep sanctuary logic tied to trust sponsorship and faction exceptions | [church](location-profiles/church.md) |
...
| Barracks | Guard and logistics zone | Existing | Faction gate | High | Keep | Review complete | Keep as threshold demonstration anchor at 60 and 80 suspicion | [barracks](location-profiles/barracks.md) |
...
| Manor Courtyard | Manor authority zone | Existing | Faction gate | High | Keep | Review complete | Gate access by sponsorship and progression, not only hard lock | [manor-courtyard](location-profiles/manor-courtyard.md) |
