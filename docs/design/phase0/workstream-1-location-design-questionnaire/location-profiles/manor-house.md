---
title: Location Profile Manor House
description: Detailed Workstream 1 profile for the Manor House zone
ms.date: 2026-06-28
ms.topic: reference
keywords:
  - location profile
...
| Field | Value |
|---|---|
| Location name | Manor House |
| Zone key | `manor_house` |
...
1. Assimilation pressure culminates in formal behavioral scrutiny.
2. Player learns high-status protocol and consequence of mismatch.
3. Non-stealth reduction depends on sponsorship and accumulated trust.
4. Keep this location sealed from early explicit identity reveal content.
...
| Threshold visibility priority (35, 60, 80) | 60 and 80 for high-stakes late interactions |
| Immediate NPC reactions by threshold | 35: formal warning. 60: expulsion. 80: immediate detention |
...
| Prompt | Answer |
|---|---|
| Direct connected locations | Manor courtyard |
...
| Prompt | Answer |
|---|---|
| Why keep this location in Phase 1 scope | Required for late-stage progression framing and reveal pacing |
| If revised, what is the minimum revision | Define limited-entry slices before full access |
| If cut, what location absorbs its function | No valid replacement without narrative architecture changes |
| Decision owner and review date | Narrative design, 2026-06-28 |

## Open issues

| ID | Question | Impact | Owner | Due date | Fallback rule |
|---|---|---|---|---|---|
| WS1-MANOR-HOUSE-001 | Which interior areas remain off-limits until post-Phase 1 | High | Narrative design | 2026-07-06 | Keep only audience chamber accessible |
