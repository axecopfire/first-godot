---
title: Location Profile Church
description: Detailed Workstream 1 profile for the Church zone
ms.date: 2026-06-28
ms.topic: reference
keywords:
  - location profile
...
| Prompt | Answer |
|---|---|
| Direct connected locations | Alley network, tailor back route, workshop proximity |
...
| Prompt | Answer |
|---|---|
| Why keep this location in Phase 1 scope | It is the clearest sponsorship-driven non-stealth recovery path |
| If revised, what is the minimum revision | Formalize exception rules when guards can enter |
| If cut, what location absorbs its function | None without major loss of social sponsorship mechanic |
...
|---|---|---|---|---|---|
| WS1-CHURCH-001 | Should sanctuary protection cap at threshold 60 or 80 | High | Systems design | 2026-07-01 | Cap sanctuary at 60 initially |
